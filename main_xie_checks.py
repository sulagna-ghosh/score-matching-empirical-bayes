...
experiments_xie.save_marginals_data_location_scale(seeds,
                                                   ...
                                                   misspec_model_dict, NPMLEinit_model_dict, surels_model_dict, expanded=True,
...
experiments_xie.save_empirical_marginals_data_location_scale(seeds,
                                                             data_dict, parameteric_model_dict, NPMLE_model_dict, 
                                                             wellspec_model_dict, misspec_model_dict, NPMLEinit_model_dict,
                                                             experiments=experiments) 