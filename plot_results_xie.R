...
read_path = paste("results/xie_losses/") 
...
ggsave("results/xie_plots/marginal_posterior_1.png", width = 4, height=5)
...
ggsave("results/xie_plots/marginal_posterior_5.png", width = 4, height=5) 
...
ggsave("results/xie_plots/combined_marginal_shrinkage_truncate_axes.png", width = 7, height=5)
...
ggsave("results/xie_plots/combined_marginal_shrinkage_whole_axes.png", width = 7, height=5)
...
ggsave("results/xie_plots/e_prior.png", height=6, width=10)
